...
@section('title', get_option('site_title', 'Sairox CMS'))

@section('content')
<div class="max-w-4xl mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">{{ get_option('site_title', 'Sairox CMS') }}</h1>
    <div class="grid gap-6">
        ...
        @empty
        <p class="text-gray-500 text-center py-12">No posts published yet.</p>
        @endforelse
    </div>
</div>
@endsection
