...
@section('title', 'Page Not Found - ' . get_option('site_title', 'Sairox CMS'))
...
<div class="max-w-4xl mx-auto px-4 py-16 text-center">
    ...
    <a href="{{ url('/') }}" class="inline-block px-6 py-3 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition-colors">
        Back to Home
    </a>
</div>
@endsection
